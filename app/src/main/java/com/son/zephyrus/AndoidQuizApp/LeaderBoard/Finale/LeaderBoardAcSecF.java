package com.son.zephyrus.AndoidQuizApp.LeaderBoard.Finale;
...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSecF;
...
public class LeaderBoardAcSecF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leader_board_ac_sec_f);mUsersRecyclerView=(RecyclerView)findViewById(R.id.recycler_view_users);
        setAuthInstance();
        setUsersDatabase();
        setUserRecyclerView();
        setUsersKeyList();
