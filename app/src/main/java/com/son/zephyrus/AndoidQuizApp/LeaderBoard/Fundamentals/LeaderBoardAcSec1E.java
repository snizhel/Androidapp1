package com.son.zephyrus.AndoidQuizApp.LeaderBoard.Fundamentals;
...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSec1E;
...
public class LeaderBoardAcSec1E extends AppCompatActivity {
    ...
    private LeaderBoardSec1E leaderBoardAdapterSec1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board_ac_sec1_e);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec1E(this, new ArrayList<UserModel>());
