...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSec3B;
...
public class LeaderBoardAcSec3B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leader_board_ac_sec3_b);setAuthInstance();
