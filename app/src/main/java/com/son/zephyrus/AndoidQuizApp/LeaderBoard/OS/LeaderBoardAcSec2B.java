...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSec2B;
...
public class LeaderBoardAcSec2B extends AppCompatActivity {
    ...
    private LeaderBoardSec2B leaderBoardAdapterSec1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board_ac_sec2_b);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec2B(this, new ArrayList<UserModel>());
