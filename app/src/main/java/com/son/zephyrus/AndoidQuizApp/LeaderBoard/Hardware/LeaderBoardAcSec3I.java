package com.son.zephyrus.AndoidQuizApp.LeaderBoard.Hardware;
...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSec3I;
...
public class LeaderBoardAcSec3I extends AppCompatActivity {
    ...
    private LeaderBoardSec3I leaderBoardAdapterSec1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board_ac_sec3_i);setAuthInstance();
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec3I(this, new ArrayList<UserModel>());
