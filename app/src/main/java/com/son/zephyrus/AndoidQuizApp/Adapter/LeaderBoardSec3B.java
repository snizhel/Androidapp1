...
public class LeaderBoardSec3B extends RecyclerView.Adapter<LeaderBoardSec3B.ViewHolderUsers> {
    ...
    @Override
    public LeaderBoardSec3B.ViewHolderUsers onCreateViewHolder(ViewGroup parent, int viewType) {
        if(viewType == 1){
    ...
    @Override
    public void onBindViewHolder(LeaderBoardSec3B.ViewHolderUsers holder, int position) {
        sortingScore();
