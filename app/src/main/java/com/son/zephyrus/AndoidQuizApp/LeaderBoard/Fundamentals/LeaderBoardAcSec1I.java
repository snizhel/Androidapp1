...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSec1I;
...
public class LeaderBoardAcSec1I extends AppCompatActivity {
    ...
    private LeaderBoardSec1I leaderBoardAdapterSec1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board_ac_sec1_i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec1I(this, new ArrayList<UserModel>());
