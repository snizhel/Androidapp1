package com.son.zephyrus.AndoidQuizApp.LeaderBoard.OS;
...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSec2E;
...
public class LeaderBoardAcSec2E extends AppCompatActivity {
    ...
    private LeaderBoardSec2E leaderBoardAdapterSec1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board_ac_sec2_e);setAuthInstance();
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec2E(this, new ArrayList<UserModel>());
