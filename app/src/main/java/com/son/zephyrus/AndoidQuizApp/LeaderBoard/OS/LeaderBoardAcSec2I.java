...
import com.son.zephyrus.AndoidQuizApp.Adapter.LeaderBoardSec2I;
...
public class LeaderBoardAcSec2I extends AppCompatActivity {
    ...
    private LeaderBoardSec2I leaderBoardAdapterSec1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leader_board_ac_sec2_i);
    ...
    private void setUserRecyclerView() {
        leaderBoardAdapterSec1 = new LeaderBoardSec2I(this, new ArrayList<UserModel>());
