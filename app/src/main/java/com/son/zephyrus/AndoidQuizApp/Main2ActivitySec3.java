package com.son.zephyrus.AndoidQuizApp;
...
import com.son.zephyrus.AndoidQuizApp.Model.QuestionHardWare;
...
public class Main2ActivitySec3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Main2ActivitySec3.CounterClass timer = new CounterClass(1800000, 1000);
        timer.start();
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("If you close all your answer will not be saved... Do you want to exit ?")
                .setCancelable(false)
